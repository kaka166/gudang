...
class GudangControllers extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('gud.index',compact('gud'))->with('i', (request()->input('page', 1) -1) * 30);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('gud.index')->with('succes','Data Berhasil di Input');
    }
    ...
    public function update(Request $request, Gudang $gud)
    {
        ...
        return redirect()->route('gud.index')->with('succes','Siswa Berhasil di Update');
    }
